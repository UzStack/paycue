...
// Statistika nav — faqat backend (StatsDashboard) yoqilganda ko'rinadi.
const STATS_NAV = {
  to: '/dashboard/stats',
  label: 'Statistika',
  icon: (
...
export default function Layout() {
  ...
  useEffect(() => {
    api.stats()
      .then((d) => setStatsEnabled(!!d?.enabled))
      .catch(() => setStatsEnabled(false))
  }, [])

  const navItems = statsEnabled ? [...NAV, STATS_NAV] : NAV
